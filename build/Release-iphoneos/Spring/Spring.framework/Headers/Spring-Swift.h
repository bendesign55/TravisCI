...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Spring",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Spring12AutoTextView")
...
SWIFT_CLASS("_TtC6Spring24KeyboardLayoutConstraint") SWIFT_AVAILABILITY(tvos,unavailable)
...
SWIFT_CLASS("_TtC6Spring11LoadingView") SWIFT_AVAILABILITY(tvos,unavailable)
